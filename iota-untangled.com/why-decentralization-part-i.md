...
- The second post suggests [How to decentralize](https://iota-untangled.com/how-to-decentralize-part-ii/).
...
Besides its meaning for humans, an additional emphasis is put on the importance of decentralization for autonomous machines. Since this is a blog that looks into the implications of a [machine economy](https://iota-untangled.com/tag/machine-economy/).

## What is decentralization exactly?
Although “decentralization” is considered the gold standard in cryptocurrency, the exact definition or even its distinction from distributed networks is not always made clear.3 The most basic and neutral [definition of decentralization](https://www.merriam-webster.com/dictionary/decentralization) is “the dispersion or distribution of functions and powers.” But what does this mean? And why is it important? And is there a point where further decentralization has reduced benefits or even severe disadvantages?


Visualization of Centralized, Decentralized and Distributed Networks, based on Paul Baran’s “[On distributed communications networks](http://pages.cs.wisc.edu/~akella/CS740/F08/740-Papers/Bar64.pdf)” – September 1962.
...
More and more people are waking up to the problems the tech giants’ core business model present. If you’re not aware yet, read [Surveillance Giants](https://www.amnesty.org/download/Documents/POL3014042019ENGLISH.PDF) by Amnesty International.
...
The image above is a generalized concept based on this [source](https://mobile.twitter.com/drewaharris/status/1236049761284820992).

### Compartmentalization
[Compartmentalization](https://en.wikipedia.org/wiki/Compartmentalization) is separating two or more parts of a system. Distributing functions over multiple parts diminishes the attack surface, and reduces its potential damage.

### Containment
[Containment](https://en.wikipedia.org/wiki/Containment_(disambiguation)) aims to prevent a malfunction from spreading through the system, which can result in the system cascading into collapse.

### Redundancy
[Redundancy](https://en.wikipedia.org/wiki/Redundancy) adds extra elements not strictly required to operate, and work in case other elements fail. They then take over (parts of) their function.

### Mitigation
[Mitigation](https://en.wikipedia.org/wiki/Mitigation) is about actions that dilute the effects of a disruption. This is not as much about minimizing the total damage as it is about spreading the load on the system.
